...
public class TinyHttpServletRequest implements HttpServletRequest {
    ...
    public TinyHttpServletRequest(Socket socket, HashMap<String, String> reqMap) {
        this.socket = socket;
        this.reqMap = reqMap;
    ...
    @Override
    public String getRemoteHost() {//reverse dns??
        return socket.getRemoteSocketAddress().toString();
    }
